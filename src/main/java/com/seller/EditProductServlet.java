...
@WebServlet(name = "sellerEditProductServlet", value = "/utilisateur/vendeur/modifier_produit")
public class EditProductServlet extends HttpServlet {

    Product product = null;
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("/seller/edit_product.jsp");
        try{
            ...
            if (idParameter == null || idParameter.isEmpty()) {
                ...
                response.sendRedirect("/utilisateur/vendeur");
                return;
            }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try{
            ...
            if(Integer.parseInt(request.getParameter("u")) != LOGIN_USER.getId()) {
        ...
        getServletContext().getRequestDispatcher("/seller/edit_product.jsp").forward(request, response);
    }
}
